...
class Ciudad():
    ...
    """
    def __init__(self, L=100, CBD = 50, H = [33300, 33300, 33300], y = [100.0, 20.0, 4.0],  ancho_celda=0.01):
        # Parámetros (input)
    ...
    def resolver_equilibrio(
            ...
            max_iter = 10000):
        """
        Resuelve utilidades normalizadas u barra según ecuación (5.4)
        """
        if T is None:
            T = self.T
    ...
    def asignar_hogares_simple(self): # TODO implementar
        ...
        for i in range(num_parcelas):
            ...
            for _ in range(capacidad):
                ...
                h = np.random.choice(num_estratos, p=probs) +1 # +1 para que no parta de 0
